...
// Set the initial max-height of the menu to 0
MenuItems.style.maxHeight = "0px";

// Function to toggle the menu's max-height
function menutoggle() {
...
function displayProduct() {
    for (var key in watches[selectedBrand]) {
        ...
        if (detail.name === selectedProduct) {


            data = `
                <div class="card  style="width: 18rem;" rounded">
                    <img src="${detail.img}" class="card-img-top" alt="..." width="300">
                    <div class="card-body bg-light">
